...
选择以下任一平台，点击一键部署按钮，即可快速创建自己的 JoyyaTV 实例：

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FJoyyaSpark%2FJoyyaTV) [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/JoyyaSpark/JoyyaTV) 

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/JoyyaSpark/JoyyaTV) 
...
services:
  Joyyatv:
    image: bestzwei/Joyyatv:latest
    container_name: Joyyatv
    ports:
      - "8899:80"
    environment:
      - PASSWORD=111111
